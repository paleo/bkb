module wocext {
	...
	export interface RDataset {
		 ...
		 * </pre>
		*/
		query(query: {}): DatasetQueryResult;
		/**
	...
	class GenericDataset implements Dataset {
		...
		public query(query: {}): DatasetQueryResult {
	...
	class GenericReadOnlyDataset implements RDataset {
		...
		public query(filter: {}): DatasetQueryResult {
	...
	class GenericQueryResult implements DatasetQueryResult {
